      ...
      <div className="w-full max-w-md bg-[var(--color-surface)] p-8 rounded-2xl shadow-sm border border-[var(--color-surface-border)]">
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-4">
          ...
          <button 
            type="submit" 
            disabled={loading}
            className="w-full mt-4 py-3 bg-[var(--color-accent)] text-white rounded-lg font-medium hover:bg-[var(--color-accent-hover)] transition-colors disabled:opacity-70"
          >
